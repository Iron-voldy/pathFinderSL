...
const Hotels = () => {
  ...
  const resetFilters = () => {
    ...
    setSearchForm({ location: '', checkIn: '', checkOut: '', rooms: '1', guests: '2' });
  };
            ...
            <form className="search-bar" onSubmit={handleSearch}>
              ...
              <div className="search-field search-field--guests">
                ...
                <div className="search-input-wrapper">
                  ...
                  <span className="guests-text">{searchForm.rooms} Room, {searchForm.guests} Guests</span>
                </div>
              </div>
                          ...
                          <div className="hotel-card-body">
                            ...
                            <div className="hotel-card-footer">
                              ...
                              <div className="hotel-price">
                                <span className="price-amount">USD {hotel.markup || 45}</span>
