...
export default function BudgetPlanner() {
  ...
  const handleExportCSV = async () => {
    ...
    setExporting(true);
    try {
      const resp = await budgetAPI.getReport(reportPlan.id, {
      ...
      link.href = url;
      link.setAttribute('download', `budget_report_${reportPlan.plan_name.replace(/[^a-z0-9]/gi, '_').toLowerCase()}.csv`);
          ...
          <div className="bp-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bp-report-modal-body">
              <p style={{ marginBottom: '1.5rem', opacity: 0.7, fontSize: '0.9rem' }}>
                Download report for <strong>{reportPlan.plan_name}</strong>. Select a date range or leave blank for all days.
              </p>
